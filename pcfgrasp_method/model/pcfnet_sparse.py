...
class PCFNet(nn.Module):
    def __init__(self, args, global_config):
        ...
        self.layer1 = nn.Sequential(
            ME.MinkowskiConvolution(in_channels=128, out_channels=128, kernel_size=1, stride=1, dilation=1, has_bias=True),
            ME.MinkowskiBatchNorm(128),
            ME.MinkowskiReLU(),
            ME.MinkowskiDropout(0.5),
            ME.MinkowskiConvolution(in_channels=128, out_channels=3, kernel_size=1, strdie=1, dilation=1, has_bias=True)
        )
        ...
        self.layer3 = nn.Sequential(
            ...
            ME.MinkowskiReLU(),
            ME.MinkowskiDropout(0.5),
            ME.MinkowskiConvolution(in_channels=128, out_channels=1, kernel_size=1, strdie=1, dilation=1, has_bias=True)
        )
        ...
        self.layer4 = nn.Sequential(
            ...
            ME.MinkowskiReLU(),
            ME.MinkowskiDropout(0.5),
            ME.MinkowskiConvolution(in_channels=128, out_channels=10, kernel_size=1, strdie=1, dilation=1, has_bias=True)
        )
